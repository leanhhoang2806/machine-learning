...
# Create a labeled dataset from the images in the subfolders using list_files()
file_pattern = data_directory + "*/*.jpg"
...
# Map the preprocess function to the dataset and batch it
...
for name, model in models:
    ...
    scores = []
    for train_index, val_index in kfold.split(dataset):  # Modified here
        train_data = dataset.skip(val_index.size)
        val_data = dataset.take(val_index.size)
